...
TARGET_CONVERSATION="redis-client redis-master-a redis-client redis-master-b redis-client redis-slave-a redis-client redis-slave-b redis-client redis-slave-a redis-client redis-slave-b redis-client"
